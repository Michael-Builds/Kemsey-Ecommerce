    ...
    <div className="container grid md:grid-cols-4 grid-cols-2 gap-6 pt-4 md:pb-8 items-start">
      ...
      <div className="col-span-1 bg-white px-4 pb-6 shadow-lg rounded overflow-hidden hidden md:block">
        <div className="divide-y divide-gray-200 space-y-5 mt-4">
          <div>
            <h3 className="md:text-lg text-gray-800 mb-3 font-quicksand uppercase font-semibold">
              Categories
            </h3>
            <div className="space-y-2 font-quicksand">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-auto text-gray-600 text-sm">
                  (
                  {
                    products.filter((product) => product.category === "Outdoor")
                      .length
                  }
                  )
                </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-auto text-gray-600 text-sm">
                  (
                  {
                    products.filter((product) => product.category === "Office")
                      .length
                  }
                  )
                </div>
            ...
            <div className="flex items-center gap-2">
              <div className="size-selector">
                <input
                  ...
                  className="hidden"
                />
                <label className="text-xs font-quicksand border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-600">
                  XS
                </label>
              </div>
              <div className="size-selector">
          ...
          <div className="pt-4">
            ...
            <div className="flex items-center gap-2">
              <div className="color-selector bg-pink-900">
                ...
                <label className="border border-pink-900 rounded-sm h-6 w-6 cursor-pointer shadow-sm block"></label>
              </div>
              <div className="color-selector bg-green-800">
                <input
                  ...
                  className="hidden"
                />
                <label className="border border-green-800 rounded-sm h-6 w-6  cursor-pointer shadow-sm block"></label>
              </div>
              <div className="color-selector bg-orange-800">
                <input
                  ...
                  className="hidden"
                />
                <label className="border border-orange-800 rounded-sm h-6 w-6  cursor-pointer shadow-sm block"></label>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="col-span-3">
        ...
        <div className="flex items-center md:mb-6 mb-8">
          ...
          <div className="flex gap-2 ml-auto">
            <div
              className={`border w-10 h-9 flex items-center justify-center rounded cursor-pointer ${
                activeView === "grid"
        ...
        <div className="grid cursor-pointer grid-cols-2 md:grid-cols-4 gap-6 ">
          {getFilteredProductsBySearch()
            .slice(0, visibleProducts)
            .map((product, index) => (
              <div
                key={index}
                className="bg-white shadow rounded overflow-hidden group shadow-lg coded relative"
              >
                ...
                <div className="pt-4 pb-3 px-4">
                  ...
                  <div className="flex items-baseline items-center justify-center mb-1 space-x-2 ">
                    <p className="md:text-xl text-md text-primary font-semibold text-center">
                      {product.price}
                    </p>
                  ...
                  <div className="flex items-center  text-center justify-center mt-2">
                    ...
                    <div className="text-sm text-gray-500 font-quicksand ml-3">
                ...
                <button
                  ...
                  className="block w-full py-1 text-center text-white font-quicksand gradient-button transition"
                >
                  Add to cart
                </button>
